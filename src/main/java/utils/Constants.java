...
public class Constants {
    ...
    public static final String petPhotosDirectory = new File("").getAbsolutePath() + "/src/test/resources/petPhotos/";
    public static final String txtDirectory = new File("").getAbsolutePath() + "/src/test/resources/txt/";
